 ...
 */
package pe.gob.mimp.siscap.repository.vwactividadcalendario.impl;
...
import pe.gob.mimp.siscap.repository.vwactividadcalendario.CustomVwActividadCalRepository;
 ...
 * @author Omar
 */
public class VwActividadCalRepositoryImpl implements CustomVwActividadCalRepository {
    ...
    @Override
    public List<VwActividadCalendario> findByParams(Map<String, Object> parameters, String orderBy) {
//        logger.info(":: VwActividadCalendarioFacade.findByParams :: Starting execution...");
...
//        logger.info(":: VwActividadCalendarioFacade.findByParams :: Execution finish.");
        return q.getResultList();
    }

    @Override
    public int getRecordCount(Map<String, Object> parameters) {
//        logger.info(":: VwActividadCalendarioFacade.getRecordCount :: Starting execution...");
...
//        logger.info(":: VwActividadCalendarioFacade.getRecordCount :: Execution finish.");
        return ((Long) q.getSingleResult()).intValue();
    }

    private String buildSelectClause() {
        String selectClause = "from VwActividadCalendario to ";
    ...
    private String buildWhereClause(Map<String, Object> parameters) {
        ...
        if (parameters.get("txtTema") != null) {
            ...
            whereClause = whereClause + "to.txtTema = :txtTema";
        }
        ...
        if (parameters.get("txtNombres") != null) {
            whereClause = (!"".equals(whereClause) ? whereClause + " " + CoreConstant.CONDITION_AND + " " : "");
            whereClause = whereClause + "to.txtNombres = :txtNombres";
        }
        if (parameters.get("fecInicio") != null) {
            whereClause = (!"".equals(whereClause) ? whereClause + " " + CoreConstant.CONDITION_AND + " " : "");
            whereClause = whereClause + "to.fecInicio = :fecInicio";
        }
        if (parameters.get("fecFin") != null) {
            whereClause = (!"".equals(whereClause) ? whereClause + " " + CoreConstant.CONDITION_AND + " " : "");
            whereClause = whereClause + "to.fecFin = :fecFin";
        }
    ...
    private String buildOrderByClause(String orderBy) {
        ...
        for (String orderByElement : orderByArray) {
            ...
            if ("txtTema".equals(orderByElement)) {
                orderByClause = (!"".equals(orderByClause) ? orderByClause + " " + CoreConstant.SEPARATOR_COMA + " "
                        : "");
                orderByClause = orderByClause + "to.txtTema";
            }
        }
